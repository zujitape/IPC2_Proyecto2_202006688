...
class matrizDispersa():
    ...
    def verTipoCelda(self, tipo):
        i = 1
        while self.filas.getCabecera(i) != None:
            tmp : nodoCelda = self.filas.getCabecera(i).getAcceso()
            while tmp != None:
                if tmp.tipoCelda == tipo:
                    print("[",tmp.coordenadaX,",", tmp.coordenadaY,"]")
                tmp = tmp.getDerecha()
            i += 1
    ...
    def graficar(self, ciudad, tipoMision, tipoRobot, nombreRobot, x, y, texto):
        name = "graphvizMision"
        with open(name + ".dot", "w") as dot:
            ...
            dot.write('}label=<<table border="0" cellborder="0" cellspacing="0">\n')
            dot.write('<tr><td bgcolor="black">The</td><td> Intransitable</td><td width = "30"></td></tr>\n')
            dot.write('<tr><td bgcolor="#70ad47"></td><td>  Punto de entrada</td><td></td></tr>\n')
            dot.write('<tr><td bgcolor="white"></td><td> Camino</td><td></td></tr>\n')
            dot.write('<tr><td bgcolor="#c30a09"></td><td> Unidad militar</td><td></td></tr>\n')
            dot.write('<tr><td bgcolor="#2d71b1"></td><td> Unidad civil</td><td></td></tr>\n')
            dot.write('<tr><td bgcolor="#636161"></td><td> Recurso</td><td></td></tr>\n')
            dot.write('<tr><td height = "50"></td><td></td></tr>\n')
            dot.write('<tr><td colspan="3" align="center">__________________________________________</td></tr>')
            dot.write('<tr><td colspan="3" align="center">Tipo de mision:'+tipoMision+' </td></tr>\n')
            dot.write('<tr><td colspan="3" align="center">'+ texto + x+ ","+y +'</td></tr>\n')
            dot.write('<tr><td colspan="3" align="center">Robot utilizado:'+nombreRobot + ' ('+ tipoRobot +') </td></tr>\n')
            dot.write('<tr><td colspan="3" align="center">__________________________________________</td></tr>')
            dot.write('</table> >;\n')
            dot.write('}')
        system("dot -Tpng graphvizMision.dot -o graphvizMision.png")
        startfile("graphvizMision.png")
